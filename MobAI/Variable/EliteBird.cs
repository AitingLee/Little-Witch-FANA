...
public class EliteBird : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        RedSphereProjectile RP = projectileFX.GetComponent<RedSphereProjectile>();
        RP.redAttackPower = m_mobAI.m_fAttackPower;
        RP.redProjectileRate = m_fProjectileRate;
    }
    ...
    private void ProjectileAttack()
    {
        ...
        if (!projectileFX.gameObject.activeSelf)
        {
            projectileFX.gameObject.SetActive(true);
        }
        projectileFX.Clear();
        projectileFX.Play();
        AudioManager.instance.projectile3.Play();
