...
public class MobVampire : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        LightningProjectile LP = skillFX.GetComponent<LightningProjectile>();
        LP.lightningAttackPower = m_mobAI.m_fAttackPower;
        LP.lightningProjectileRate = m_fSpellRate;
    }
